...
test -f "$DEST/INSTALL-MANIFEST.json"
grep -Eq '"source_commit": "[0-9a-f]{40}"' "$DEST/INSTALL-MANIFEST.json"
test -f "$BOOK_FORGE_CONFIG_HOME/agents/book-forge-orchestrator.md"
test -f "$BOOK_FORGE_CONFIG_HOME/commands/book-forge.md"
test ! -d "$DEST/scripts/__pycache__"
