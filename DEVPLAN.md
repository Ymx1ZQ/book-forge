...
- [ ] The reader reads a chapter in slices, each call bounded as now; the pass records coverage
...
- [ ] The translator's prompt gains the covered-source procedure — the six interference classes go in as its worked examples, not as a third statement of a rule it already has twice
- [ ] `bakeoff --role translator`: one chapter, N models, identical capsule, nothing promoted; drafts land beside the writer's
...
- [ ] The glossary is checked against itself; landfall's rows 105 and 134 are the fixture
